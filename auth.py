    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                cv2.putText(frame, ans, (40, 100), cv2.FONT_HERSHEY_SIMPLEX,1, (0, 0,255 ), thickness=3)
                cv2.putText(frame, ans111, (40, 200), cv2.FONT_HERSHEY_SIMPLEX,1, (0, 200,255 ), thickness=3)
