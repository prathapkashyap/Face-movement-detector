        ...
        if ret:
            ...
            if len(face_rects) > 0:
                ...
                if (int(euler_angle[1,0])>20 and count_right==0):
                    ...
                    cv2.imwrite('images/right_'+str(random.randint(0,1999999))+'.png',newframe)  
                    print()
                    right_flag=1
                    count_right+=1
                ...
                if (int(euler_angle[1,0])<-20 and count_left==0):
                    left_flag=1
                    count_left+=1
                    cv2.imwrite('images/left_'+str(random.randint(0,1999999))+'.png',newframe)  
                ...
                if(int(euler_angle[0,0])>13 and count_down==0):
                    down_flag=1
                    count_down+=1
                    cv2.imwrite('images/down_'+str(random.randint(0,1999999))+'.png',newframe)  
                ...
                if (int(euler_angle[0,0])<-17 and count_top==0):
                    top_flag=1
                    count_top+=1
                    cv2.imwrite('images/top_'+str(random.randint(0,1999999))+'.png',newframe)  
            ...
            if(count_down==1 and count_left==1 and count_right==1 and count_top==1):
                ...
                cv2.putText(frame,'the window will close now ',(120,120),cv2.FONT_HERSHEY_SIMPLEX,1, (0, 0,255 ), thickness=2)
                close_count+=1
                #print(close_count)
                if(close_count>40):
                    break
